...
class DriverHomeAcceptOrderDialog extends StatelessWidget {
  const DriverHomeAcceptOrderDialog({
    super.key,
    required this.order,
      ...
      content: ConstrainedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              locale.driver_home_accept_order_dialog_title,
              textAlign: TextAlign.center,
              style: getBoldStyle(
                fontFamily: FontConstant.cairo,
            ...
            Text(
              locale.driver_home_accept_order_dialog_message(
                order.title,
                order.vendorName,
              ),
              textAlign: TextAlign.center,
